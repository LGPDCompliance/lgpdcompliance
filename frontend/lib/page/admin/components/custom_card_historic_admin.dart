...
class CustomCardHistoricAdmin extends StatelessWidget {
  CustomCardHistoricAdmin({Key? key, required this.historicModel}) : super(key: key);
            ...
            children: [
              Row(
                ...
                children: [
                  ...
                  CustomText(text: 'Quiz realizado em ' +
                      formatter.format(historicModel.createdAt)),
                ],
              ),
              Row(
                mainAxisAlignment: MainAxisAlignment.center,
                ...
                children: [
                  CustomText(
                      text: 'Score: ' + historicModel.score.toString() + '%'),
                  const SizedBox(width: 20),
                  InkWell(
